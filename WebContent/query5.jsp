...
<% 
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:hr/hr@oracle.cise.ufl.edu:1521:orcl",
		...
		String q="create view pay as (select count(*)as p_num,p_type from PAYMENT_DETAILS group by p_type)";
		
		String sql1="Select p_type from Pay where p_num=( Select max(p_num) from pay)";
	...
	<tr>
  	...
  	while(rs1.next())
  	{
		...
		<td>
		<%out.println(rs1.getString("p_type"));%>
		</td>
