...
<% 
String year=request.getParameter("yer");
String month=request.getParameter("mont");
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:hr/hr@oracle.cise.ufl.edu:1521:orcl",
		...
		String sql1="Select count(*)as number_of_cars,car_type.car_name from  Booking_Details,car_type where EXTRACT(year FROM Booking_date)='"+year+"' and EXTRACT(month FROM Booking_date)='"+month+"' and Booking_Details.CAR_ID=car_type.CAR_ID GROUP BY car_type.CAR_NAME order by car_type.CAR_NAME" ;
	...
	<tr>
  	...
  	while(rs1.next())
  	{
		...
		<td>
		<%out.println(rs1.getString("car_name"));%>
		</td>
